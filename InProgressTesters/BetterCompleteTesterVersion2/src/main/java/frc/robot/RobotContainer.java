...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    */
    ...
    ControllerSubsystem.getClawOpenButton().whileTrue(new ClawCommand(pneumaticClawSubsystem, ClawDirection.OPEN));
    ControllerSubsystem.getClawCloseButton().whileTrue(new ClawCommand(pneumaticClawSubsystem, ClawDirection.CLOSE));

    ControllerSubsystem.getCorrectChassisOrientationButton().whileTrue(new CorrectRobotX(limelightSubsystem));
    ControllerSubsystem.getCorrectElevatorOrientationButton().whileTrue(new CorrectRobotY(limelightSubsystem));
  }
