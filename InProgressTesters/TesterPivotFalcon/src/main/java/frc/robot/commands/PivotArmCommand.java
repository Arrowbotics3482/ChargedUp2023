...
public class PivotArmCommand extends CommandBase {
  ...
  public void initialize() {
    ...
    {
      PivotArmSubsystem.getPivotMotor().set(ControlMode.PercentOutput, -1 * Constants.PIVOT_MOTOR_SPEED);
    }
    else if(pivotDirection == PivotDirection.DOWN)
    {
      // PivotArmSubsystem.getPivotMotor().set(0, Constants.PIVOT_MOTOR_SPEED);
      PivotArmSubsystem.getPivotMotor().set(ControlMode.PercentOutput, Constants.PIVOT_MOTOR_SPEED);
    }
  }
  ...
  public void end(boolean interrupted) {
    PivotArmSubsystem.getPivotMotor().set(ControlMode.PercentOutput, 0);
  }
